...
function installNghdl
{
    ...
    cd nghdl/install-nghdl-scripts
    chmod +x install-nghdl-24.04.sh
    ./install-nghdl-24.04.sh --install
    cd ../../
}
...
{
    echo "Skipping IHP Open PDK installation on Ubuntu 25.04 during Task 4 testing"
}
...
{    
    ...
    echo "Skipping Desktop icon creation in headless Codespaces environment"
